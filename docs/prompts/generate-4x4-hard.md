# Generate 4x4 Hard CleverGrid Case

Use this prompt to generate a 4x4 hard CleverGrid case.

```text
Generate one CleverGrid 4x4 hard case JSON object.
...
- use a higher proportion of notSame rules
- use fewer direct same clues than easy or medium prompts
- clue wording can be more indirect, but every deduction must still be represented in rules
- rules must still guarantee a unique solution
- do not create difficulty by leaving the case underconstrained
